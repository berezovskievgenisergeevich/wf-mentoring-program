...
public class Task2 {
    ...
    public static void invokeMethod(Class aClass, String methodName) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException, InstantiationException {
